...
function nightView() {
	document.getElementById('wrapper').style.backgroundImage = "url(night_view.jpg)";
...
function treeHugger() {
	document.getElementById('wrapper').style.backgroundImage = "url(tree_hugger.jpg)";
...
function sportsFan() {
	document.getElementById('wrapper').style.backgroundImage = "url(lakers.jpg)";
...
function computerGeek() {
	document.getElementById('wrapper').style.backgroundImage = "url(code.gif)";
